...
final class AuditLogger
{
    ...
    {
        if (! (bool) $this->config->get('ichava.security.audit.enabled', true)) {
            return;
        }

        $allowed = (array) $this->config->get('ichava.security.audit.events', []);
    ...
    {
        $channel = (string) $this->config->get('ichava.security.audit.channel', 'ichava-audit');
    ...
    {
        if (! (bool) $this->config->get('ichava.security.audit.dispatch_event', true)) {
            return;
        }

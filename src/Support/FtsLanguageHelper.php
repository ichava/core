...
final class FtsLanguageHelper
{
    ...
    {
        return config('ichava.database.search.strategy', 'simple');
    }
    ...
    {
        $language = config('ichava.database.search.language', 'simple');
    ...
    public static function getLanguages(): array
    {
        ...
        $languages = config('ichava.database.search.languages', ['simple', 'english']);

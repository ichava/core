...
describe('SVG Sanitizer', function () {
    ...
    it('removes an xlink:href that points outside the document', function () {
        // This test asserted that *every* xlink:href was removed, using
        // "#evil" as the example -- a same-document fragment, which cannot
        // fetch, leak or execute. That over-blocking is SEC-1: it left <use>
        // allowed but inert and broke 261 icons across the flag, metronic and
        // bundled packs. The security property is the target of the reference,
        // not the attribute's name. Fragment cases are in
        // SvgFragmentReferenceTest.
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="https://evil.test/x.svg#a"/></svg>';

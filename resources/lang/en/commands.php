...
return [
    ...
    // Support\Seeder\IchavaSeeder -- the output of `database seed`
    'seeder' => [
        'header'              => '🚀 Ichava Icon Database Seeding',
        'discovering'         => '🔄 Discovering registered icon packages...',
        'found'               => '📋 Found :count package(s)',
        'icons_found'         => 'Icons found: :count',
        'no_icons'            => '⚠ No icons to seed',
        'force_suffix'        => ' (force update)',
        'seeding_sync'        => '→ Seeding icons synchronously:force (chunk size: :size)...',
        'seeded_sync'         => '✓ Seeded :processed icons in :chunks chunks',
        'dispatching'         => '→ Dispatching seeding jobs:force (chunk size: :size)...',
        'dispatched'          => '✓ Dispatched :jobs jobs (ID: :batch)',
        'failed'              => '❌ Failed: :message',
        'seeding_terms'       => '→ Seeding terms...',
        'terms_seeded'        => '✓ Terms seeded',
        'terms_failed'        => '⚠ Terms failed: :message',
        'table_missing'       => '❌ Table "ichava_icons" does not exist!',
        'table_missing_hint'  => '💡 Run migrations first: php artisan migrate',
        'completed'           => '✅ Seeding completed!',
        'total_in_database'   => '📊 Total icons in database: :count',
        'database_unreadable' => '📊 Unable to query database. Run: php artisan :command stats',
        'summary'             => '📊 ICHAVA SEEDING SUMMARY',
        'setting'             => 'Setting',
        'mode'                => 'Mode',
        ...
        'packages_failed'    => '⚠ :count package(s) failed!',
        'packages_succeeded' => '✓ All :count package(s) processed successfully!',
        'processing_jobs'    => '⏳ Processing :count seeding jobs...',
        'jobs_processed'     => '✅ All seeding jobs processed!',
        'queue_failed'       => '❌ Queue processing failed: :message',
